...
Per ADR-007, budget DTOs live here rather than in `shared-contracts` — they are domain-specific, not cross-cutting. `TransactionType` is also authoritatively defined here.
