 ...
 *
 * Mirrors `identity-infrastructure`'s `generateTestDbName` (see
 * `2026-07-15-01` per-worker test DB isolation fix) — duplicated rather than
 * imported cross-scope (see `mongo-connection.ts`'s note on depConstraints).
 *
