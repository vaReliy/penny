 ...
 *
 * Mirrors the sibling-scope helpers used elsewhere in this repo —
 * duplicated rather than imported cross-scope (see `mongo-connection.ts`'s
 * note on depConstraints).
 *
