...
# Backend Developer — Requirement Contract Workflow

In addition to the standard backend implementation defined in `.claude/agents/backend-developer.md`, this agent operates under the requirement-contract framework when executing from a task file.
...
See `.claude/agents/backend-developer.md` for standard backend implementation workflow.
