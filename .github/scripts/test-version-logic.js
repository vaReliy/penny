...
const tests = [
  ...
  { v1: '^21.1.1', v2: '^21.1.1', expected: 0, description: '21.1.1 = 21.1.1' },
  {
    ...
    v2: '^21.1.1',
    expected: -1,
    description: '16.2.2 < 21.1.1',
  },
  {
    v1: '~5.2.3',
    v2: '^5.2.3',
    expected: 0,
    description: 'Same version with different prefixes',
  },
  {
    v1: '^19.0.1',
    v2: '^20.0.0',
    expected: -1,
    description: '19.0.1 < 20.0.0',
  },
];
...
for (const test of tests) {
  ...
  const status =
    Math.sign(result) === Math.sign(test.expected) ? '✅ PASS' : '❌ FAIL';

  console.log(`${status}: ${test.description}`);
  console.log(
    `  ${test.v1} ${resultStr} ${test.v2} (expected: ${expectedStr})`,
  );
