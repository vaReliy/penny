...
for (const pkg of angularPackages) {
  const currentVersion =
    currentPackageJson.dependencies[pkg] ||
    currentPackageJson.devDependencies[pkg];
...
if (obsoleteCount > 0 && validCount === 0) {
  ...
  console.log();
  console.log(
    'Reason: All proposed versions are lower than or equal to current versions.',
  );
  console.log(
    'This happened because PR #81 (Angular 21.1.1 upgrade) was merged,',
  );
  console.log(
    'which includes newer versions than what PR #70 proposes (21.0.1).',
  );
  console.log();
...
console.log();
console.log(
  '💡 This is a demonstration. To run the actual agent with API access:',
);
